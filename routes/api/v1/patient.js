...
const patientsController = require('../../../controller/patient_controller');
...
router.get("/:id/all-reports", passport.authenticate("jwt", {session: false}),patientsController.allReport);
